<section class="section-lg text-center">
    <div class="container">
        ...
        <p class="wow-outer"><span class="wow slideInDown text-width-1">
            Chúng tôi cung cấp tất cả các dịch vụ Spa - Grooming cho thú cưng của bạn. Chúng tôi sử dụng các sản phẩm chất lượng nhất
            phù hợp với nhu cầu.
        </span></p>
    ...
    <div class="wow-outer button-outer"><a
            class="button button-primary-outline button-winona offset-top-2 wow slideInUp" href="services.html">Tất cả dịch vụ của chúng tôi</a></div>
</section>