...
?>
        <!-- Slider Light-->
        <section class="swiper-container swiper-slider swiper-slider-light bg-image-1" data-loop="false"
            data-autoplay="false" data-simulate-touch="false" data-custom-slide-effect="inter-leave-effect"
                            ...
                            <div class="swiper-slide-caption">
                                <div class="row row-30">
                                    <div class="col-lg-6 text-center text-lg-left">
                                        ...
                                        <div class="button-outer"><a
                                                class="button button-lg button-primary button-winona" href="#">Free
                                                consultation</a></div>
                                    </div>
                                    <div class="col-lg-6 position-static">
                                        <div class="floating-image"><img src="images/swiper-image-1-960x776.jpg" alt=""
                        ...
                        <div class="container">
                            <div class="swiper-slide-caption">
                                <div class="row row-30">
                                    ...
                                    <div class="col-lg-6 position-static">
                                        <div class="floating-image"><img src="images/swiper-image-2-960x776.jpg" alt=""
                                                width="960" height="776" />
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="container">
                            <div class="swiper-slide-caption">
                                <div class="row row-30">
                                    ...
                                    <div class="col-lg-6 position-static">
                                        <div class="floating-image"><img src="images/swiper-image-3-960x776.jpg" alt=""
                                                width="960" height="776" />
                                        </div>
                                    </div>
                                </div>
        ...
        <section class="section section-decorated-1">
            <div class="decor-1"><img src="images/bubbles-219x209.png" alt="" width="219" height="209" />
            </div>
            <div class="decor-2"><img src="images/bubbles-224x306.png" alt="" width="224" height="306" />
            </div>
            <div class="container">
                <div
                    ...
                    <div class="col-md-10 col-lg-6 col-xl-5">
                        ...
                        <p class="wow-outer"><span class="wow slideInDown" data-wow-delay=".05s">SpaDog is a pet salon
                                established in 1999 with the main goal of giving your pets the full furry body treatment
                                so that they can look their very best every day.</span></p>
                        <p class="wow-outer"><span class="wow slideInDown" data-wow-delay=".1s">Our salon offers a
                                complete line of fine grooming services to bring out the best of appearance and
                                personality in your pet. Our groomers work carefully, never rush, and do not overbook
                                appointments.</span></p>
                        <div class="wow-outer button-outer"><a class="button button-lg button-primary button-winona"
                                data-wow-delay=".1s" href="about-us.html">Learn more</a></div>
                    </div>
                    <div class="col-md-10 col-lg-6 wow-outer"><img class="img-responsive wow slideInLeft"
                            src="images/about-501-526.jpg" alt="" />
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="section section-md bg-gray-light">
            <div class="container">
                <div class="row row-40 align-items-center">
                    ...
                    <div class="col-xl-4">
                        <div class="offset-negative-70"><img src="images/home-2-386x503.jpg" alt="" width="386"
                                height="503" />
                        </div>
                    </div>
                </div>
        ...
        <section class="section section-xs bg-primary-darker text-center section-decorated-2">
            <div class="decor-1"><img src="images/bubbles-225x463.png" alt="" width="225" height="463" />
            </div>
            <div class="decor-2"><img src="images/bubbles-83x127.png" alt="" width="83" height="127" />
            </div>
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-sm-10 col-md-12">
                        <div class="box-cta-thin">
                            <h4 class="wow-outer"><span class="wow slideInRight">Qualified Personal Care For Your
                                    Pets</span></h4>
                            <div class="wow-outer button-outer"><a
                                    class="button button-primary button-winona wow slideInLeft" href="pricing.html">View
                                    all pricing</a></div>
                        </div>
                    </div>
                </div>
        ...
        <section class="section-lg text-center">
            <div class="container">
                ...
                <p class="wow-outer"><span class="wow slideInDown text-width-1">We offer a variety of grooming services
                        for dogs of all breeds and ages. We use only high-quality products that suit the needs of your
                        pet. Discover our most popular services below.</span></p>
                <div class="row row-30 offset-top-2">
                    <div class="col-sm-6 col-lg-3 wow-outer">
                        <!-- Thumbnail Light-->
                        <article class="thumbnail-light wow slideInLeft"><a class="thumbnail-light-media"
                                href="single-service.html"><img class="thumbnail-light-image"
                                    src="images/service-thumbnail-1-270x200.jpg" alt="" width="270" height="200" /></a>
                            <h5 class="thumbnail-light-title"><a href="single-service.html">Styling</a></h5>
                        </article>
                    </div>
                    <div class="col-sm-6 col-lg-3 wow-outer">
                        <!-- Thumbnail Light-->
                        <article class="thumbnail-light wow slideInLeft" data-wow-delay=".05s"><a
                                class="thumbnail-light-media" href="single-service.html"><img
                                    class="thumbnail-light-image" src="images/service-thumbnail-2-270x200.jpg" alt=""
                    ...
                    <div class="col-sm-6 col-lg-3 wow-outer">
                        <!-- Thumbnail Light-->
                        <article class="thumbnail-light wow slideInLeft" data-wow-delay=".1s"><a
                                class="thumbnail-light-media" href="single-service.html"><img
                                    class="thumbnail-light-image" src="images/service-thumbnail-3-270x200.jpg" alt=""
                                    width="270" height="200" /></a>
                    ...
                    <div class="col-sm-6 col-lg-3 wow-outer">
                        <!-- Thumbnail Light-->
                        <article class="thumbnail-light wow slideInLeft" data-wow-delay=".15s"><a
                                class="thumbnail-light-media" href="single-service.html"><img
                                    class="thumbnail-light-image" src="images/service-thumbnail-4-270x200.jpg" alt=""
                                    width="270" height="200" /></a>
            ...
            <div class="wow-outer button-outer"><a
                    class="button button-primary-outline button-winona offset-top-2 wow slideInUp"
                    href="services.html">View all services</a></div>
        </section>
        <!-- Pricing-->
        <section class="section section-lg bg-gray-100 section-decorated-7">
            <div class="decor-1"><img src="images/bubbles-171x230.png" alt="" width="171" height="230" />
            </div>
            <div class="container">
                    ...
                    <div class="col-sm-6 col-lg-4 wow-outer">
                        ...
                        <article class="pricing-minimal wow slideInRight" data-wow-delay=".1s">
                            ...
                            <p>This ultimate spa package is featured for the spoiled pup who needs the works and wants
                                to enjoy a day of relaxation and beauty.</p><a
                                class="button button-primary button-winona" href="single-service.html">Order now</a>
                        </article>
                    </div>
                </div>
                ...
                <div class="owl-carousel wow fadeIn" data-items="1" data-md-items="2" data-lg-items="3" data-dots="true"
                    ...
                    <blockquote class="quote-classic">
                        <div class="quote-classic-meta">
                            <div class="quote-classic-avatar"><img src="images/testimonials-person-1-96x96.jpg" alt=""
                                    width="96" height="96" />
                            </div>
                    ...
                    <blockquote class="quote-classic">
                        <div class="quote-classic-meta">
                            <div class="quote-classic-avatar"><img src="images/testimonials-person-2-96x96.jpg" alt=""
                                    width="96" height="96" />
                            </div>
                            <div class="quote-classic-info">
                    ...
                    <blockquote class="quote-classic">
                        <div class="quote-classic-meta">
                            <div class="quote-classic-avatar"><img src="images/testimonials-person-3-96x96.jpg" alt=""
                                    width="96" height="96" />
                            </div>
                            <div class="quote-classic-info">
                    ...
                    <blockquote class="quote-classic">
                        <div class="quote-classic-meta">
                            <div class="quote-classic-avatar"><img src="images/testimonials-person-4-96x96.jpg" alt=""
                                    width="96" height="96" />
                            </div>
                            <div class="quote-classic-info">
                    ...
                    <blockquote class="quote-classic">
                        <div class="quote-classic-meta">
                            <div class="quote-classic-avatar"><img src="images/testimonials-person-5-96x96.jpg" alt=""
                                    width="96" height="96" />
                            </div>
                            <div class="quote-classic-info">
                    ...
                    <blockquote class="quote-classic">
                        <div class="quote-classic-meta">
                            <div class="quote-classic-avatar"><img src="images/testimonials-person-6-96x96.jpg" alt=""
                                    width="96" height="96" />
                            </div>
                            <div class="quote-classic-info">
        ...
        <section class="section section-1 bg-primary-darker text-center section-decorated-3">
            <div class="decor-1"><img src="images/bubbles-187x131.png" alt="" width="187" height="131" />
            </div>
            <div class="decor-2"><img src="images/bubbles-295x474.png" alt="" width="295" height="474" />
            </div>
            <div class="decor-3"><img src="images/home-3-359x546.png" alt="" width="359" height="546" />
            </div>
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-sm-10 col-lg-7 col-xl-6">
                        ...
                        <div class="wow-outer button-outer"><a
                                class="button button-primary button-winona wow slideInDown" href="#"
                                data-wow-delay=".1s">Free consultation</a></div>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row row-50">
                    <div class="col-md-6 wow-outer">
                        ...
                        <article class="post-modern wow slideInLeft"><a class="post-modern-media"
                                href="single-blog-post.html"><img src="images/grid-blog-1-570x353.jpg" alt=""
                                    width="570" height="353" /></a>
                            <h4 class="post-modern-title"><a href="single-blog-post.html">How To Keep Your Dog Cool In
                                    Summer</a></h4>
                            ...
                            <p>With summer upon us, it’s natural for us to all want to get out and enjoy the sunshine.
                                However, if you’re a dog owner, extra care and consideration need to be taken during the
                                warmer months. Sun...</p>
                        </article>
                    </div>
                    <div class="col-md-6 wow-outer">
                        <!-- Post Modern-->
                        <article class="post-modern wow slideInLeft"><a class="post-modern-media"
                                href="single-blog-post.html"><img src="images/grid-blog-2-570x353.jpg" alt=""
                                    width="570" height="353" /></a>
                            <h4 class="post-modern-title"><a href="single-blog-post.html">Top Tips for Grooming an
                                    Unruly Doodle Coat</a></h4>
                            <ul class="post-modern-meta">
                                <li>by Theresa Barnes</li>
                                <li>
                                    <time datetime="2020">Apr 21, 2020 at 12:05 pm</time>
                            ...
                            <p>Doodle breeds have taken the world by storm in recent years. We’ve fallen head over heels
                                in love with Labradoodles, Cockapoos, Cavapoos and Poochons. But with all that wavy
                                fluff comes a...</p>
                        </article>
                    </div>
                </div>
                                    ...
                                    <div class="row row-10">
                                        <div class="col-md-6 wow-outer">
                                            <div class="form-wrap wow fadeSlideInUp">
                                                <label class="form-label-outside" for="contact-first-name">First
                                                    Name</label>
                                        ...
                                        <div class="col-md-6 wow-outer">
                                            <div class="form-wrap wow fadeSlideInUp">
                                                <label class="form-label-outside" for="contact-last-name">Last
                                                    Name</label>
                                        ...
                                        <div class="col-12 wow-outer">
                                            <div class="form-wrap wow fadeSlideInUp">
                                                <label class="form-label-outside" for="contact-message">Your
                                                    Message</label>
        ...
        <section class="section section-sm section-decorated-5">
            <div class="decor-1"><img src="images/bubbles-201x215.png" alt="" width="201" height="215" />
            </div>
            <div class="container">
                <div class="layout-bordered">
                    ...
                    <div class="layout-bordered-item wow-outer">
                        <div class="layout-bordered-item-inner wow slideInUp">
                            ...
                            <div><a class="link-default" href="#">2130 Fulton Street San Diego, CA 94117-1080 USA</a>
                            </div>
                        </div>
                    </div>
                </div>
